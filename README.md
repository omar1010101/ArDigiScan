...
[For more informations.](https://datacenter.aucegypt.edu/shazeem/)
 ...
 # User Interface
 To evaluate and validate our artificial model, we created a user interface using the Python library Streamlit, designed for local development and prototyping of the project.
 <br>
